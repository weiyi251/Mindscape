...
- 全量基线（2026-09-13）：Vitest **759 passed / 59 文件**、tsc 0 错、eslint 0 error（1 条既有 warning）、cargo test **47 passed**、vite build 通过（391.45 kB / gzip 120.25 kB）
...
pnpm test           # vitest run（759 tests）
pnpm lint           # eslint
