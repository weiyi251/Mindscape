...
- 全量基线（2026-09-13，自定义快捷键 + 可拖动设置弹窗 + 右键菜单归并后）：Vitest **834 passed / 62 文件**、tsc 0 错、eslint 0 error（1 条既有 warning）、cargo test **47 passed**、vite build 通过（403.13 kB / gzip 124.45 kB）
