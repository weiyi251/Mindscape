...
- 全量基线（2026-09-13）：Vitest **752 passed / 58 文件**、tsc 0 错、eslint 0 error（1 条既有 warning）、cargo test **43 passed**、vite build 通过（390.64 kB / gzip 119.97 kB）
...
pnpm test           # vitest run（752 tests）
pnpm lint           # eslint
