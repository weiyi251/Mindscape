...
// 实现任务：T0.10（准备层）。
//
// ⚠️ 接线状态（2026-09-13 订正）：本文件与其消费的 registerToolbarItem **当前未被生产代码使用**
//    —— 真实工具栏 `components/ui/icon-toolbar.tsx` 已于 2026-09-13 删除（功能并入右键菜单），
//    现在只有本文件的单测引用 buildToolbarItems()。按用户裁决 8「插件机制代码一律保留」，
//    本文件不删；待插件功能落地时再接宿主（命令面板 / 顶栏溢出菜单）。
//    详见 docs/插件功能实施方案.md 与 docs/代码审查报告-2026-09-13.md §5.3。
// ============================================================================
